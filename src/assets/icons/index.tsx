...
export const BrowserOutline = (style: ImageStyle): IconElement<ImageProps> => {
  return (
    <Icon {...style} name='browser-outline'/>
  );
};
export const ShoppingBag = (style: ImageStyle): IconElement<ImageProps> => {
  return (
    <Icon {...style} name='shopping-bag-outline'/>
  );
};
export const CalendarOutline = (style: ImageStyle): IconElement<ImageProps> => {
  return (
